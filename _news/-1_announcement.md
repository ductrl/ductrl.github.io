...
For those interested, I just simply use [al-folio](https://github.com/alshedivat/al-folio) to create this website, which you can also find the link to in the _footer_ of this website.

I spent hours looking for a template that:

- Looks beautiful
- Have a _news_ section
- Allows me to link my blog and also write blog posts if I want
- Have a _projects_ section
